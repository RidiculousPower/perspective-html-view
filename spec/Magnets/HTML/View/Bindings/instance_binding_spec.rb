...
describe ::Magnets::HTML::View::Bindings::InstanceBinding do
  ...
  before :all do
    ...
    class ::Magnets::HTML::View::Bindings::InstanceBinding::Mock
  ...
  it 'can render its view class and/or value' do
    ...
    # with to_html_node
    class_binding = ::Magnets::Bindings::AttributeContainer::HTMLView::Text.new( ::Magnets::HTML::View::Bindings::InstanceBinding::Mock, :binding_name, ::Magnets::HTML::View::Bindings::InstanceBinding::NodeView )
    ...
    class_binding = ::Magnets::Bindings::AttributeContainer::HTMLView::Text.new( ::Magnets::HTML::View::Bindings::InstanceBinding::Mock, :binding_name, ::Magnets::HTML::View::Bindings::InstanceBinding::FragmentView )
    instance_binding = ::Magnets::Bindings::AttributeContainer::HTMLView::Text::InstanceBinding.new( class_binding, Object.new )
    node = instance_binding.to_html_node( mock_doc_frame )
    node.is_a?( ::Nokogiri::XML::DocumentFragment ).should == true
    node.children[ 0 ].name.should == 'div'
    ...
    # with no view
    class_binding = ::Magnets::Bindings::AttributeContainer::HTMLView::Text.new( ::Magnets::HTML::View::Bindings::InstanceBinding::Mock, :binding_name )
    instance_binding = ::Magnets::Bindings::AttributeContainer::HTMLView::Text::InstanceBinding.new( class_binding, Object.new )
