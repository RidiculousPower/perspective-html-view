...
describe ::Magnets::HTML::View::Bindings::ClassBinding do
  ...
  it 'can ensure a view class is capable of generating html' do
    ...
    Proc.new { class_binding.__validate_view_class__( ::Magnets::HTML::View::Bindings::ClassBinding::FailView ) }.should raise_error( ::Magnets::Bindings::Exception::BindingInstanceInvalidTypeError )
    Proc.new { class_binding.__validate_view_class__( ::Magnets::HTML::View::Bindings::ClassBinding::View ) }.should_not raise_error
    
    Proc.new { ::Magnets::Bindings::AttributeContainer::HTMLView::Text.new( :binding_name, ::Magnets::HTML::View::Bindings::ClassBinding::FailView ) }.should raise_error( ::Magnets::Bindings::Exception::BindingInstanceInvalidTypeError )
    Proc.new { ::Magnets::Bindings::AttributeContainer::HTMLView::Text.new( :binding_name, ::Magnets::HTML::View::Bindings::ClassBinding::View ) }.should_not raise_error
